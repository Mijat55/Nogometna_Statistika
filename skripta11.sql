#c:\xampp\mysql\bin\mysql -uroot<C:\Users\Marko\Downloads\edunovajp27.sql\skripta11.sql

drop database if exists nogometna_statistika;
create database nogometna_statistika;
use nogometna_statistika;
